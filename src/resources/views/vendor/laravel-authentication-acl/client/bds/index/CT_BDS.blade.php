...
$less = new lessc;
$less->compileFile(public_path() . '/packages/jacopo/laravel-authentication-acl/less/CT_BDS.less', public_path() . '/packages/jacopo/laravel-authentication-acl/_css/CT_BDS.css');
?>
