    ...
    <div class="auto-container">    
        ...
        <div class="filters">
            ...
            <ul class="filter-tabs clearfix anim-3-all nav nav-tabs">
                ...
                <li class="filter"><a data-toggle="tab" href="#Kitchen">Kitchen</a></li>
                <li class="filter"><a data-toggle="tab" href="#Garage">Garage</a></li>
                <li class="filter"><a data-toggle="tab" href="#Bedroom">Bedroom</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="basictable-1 basictable row"> 
            <div class="tab-content">
                ...
                <div class="featured_houses tab-pane fade in active" id="All">
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="http://wp1.themexlab.com/wp/dreamland/wp-content/uploads/2016/01/3.jpg" alt="Ocean Home" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="http://wp1.themexlab.com/wp/dreamland/wp-content/uploads/2016/01/3.jpg" alt="House in Bel Air" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="http://wp1.themexlab.com/wp/dreamland/wp-content/uploads/2016/01/3.jpg" alt="Spacious and elegant family entertainer" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
                                <a href="#" target="_self">Spacious and elegant family entertainer</a>        </h4>
                            <div class="featured_houses_location"><i class="fa fa-map-marker"></i> Rue Louis Bleriot &nbsp;</div>              <div class="featured_houses_category">
                                <i class="fa fa-tag"></i>
                                <a href="#" class="category">
                                    Apartment</a>
                            </div>
                            <div class="featured_houses_size featured_houses_inline"><i class="fa fa-expand"></i> 375&nbsp;Sqrt</div><div class="featured_houses_rooms featured_houses_inline"><i class="fa fa-building-o"></i> Rooms: 9&nbsp;</div><div class="featured_houses_year featured_houses_inline"><i class="fa fa-tint"></i> Built year: 2014&nbsp;</div><div class="featured_houses_bedrooms featured_houses_inline"><i class="fa fa-inbox"></i> Bedrooms: 5&nbsp;</div><div class="featured_houses_hits featured_houses_inline"><i class="fa fa-eye"></i> Hits: 99</div>    </div>
                        <div class="rem_house_viewlist">
                            <a href="#" target="_self" style="display: block">
                                <div class="featured_houses_price ">750.000,00&nbsp;EUR</div><div class="featured_houses_viewlisting">View listing</div>                </a>
                            <div style="clear: both;"></div>
                        </div>
                    </div>
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="http://wp1.themexlab.com/wp/dreamland/wp-content/uploads/2016/01/3.jpg" alt="Elegantly cottage in sunny California" border="0"></a>    <div class="col_rent">
                                For rent                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
                                <a href="#" target="_self">Elegantly cottage in sunny California</a>        </h4>
                            <div class="featured_houses_location"><i class="fa fa-map-marker"></i> 10777 Santa Monica Boulevard&nbsp;</div>              <div class="featured_houses_category">
                                <i class="fa fa-tag"></i>
                                <a href="#" class="category">
                                    Apartment</a>
                            </div>
                            <div class="featured_houses_size featured_houses_inline"><i class="fa fa-expand"></i> 400&nbsp;Sqrt</div><div class="featured_houses_rooms featured_houses_inline"><i class="fa fa-building-o"></i> Rooms: 8&nbsp;</div><div class="featured_houses_year featured_houses_inline"><i class="fa fa-tint"></i> Built year: 2013&nbsp;</div><div class="featured_houses_bedrooms featured_houses_inline"><i class="fa fa-inbox"></i> Bedrooms: 4&nbsp;</div><div class="featured_houses_hits featured_houses_inline"><i class="fa fa-eye"></i> Hits: 332</div>    </div>
                        <div class="rem_house_viewlist">
                            <a href="#" target="_self" style="display: block">
                                <div class="featured_houses_price ">2.200,00&nbsp;USD</div><div class="featured_houses_viewlisting">View listing</div>                </a>
                            <div style="clear: both;"></div>
                        </div>
                    </div>
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="http://wp1.themexlab.com/wp/dreamland/wp-content/uploads/2016/01/3.jpg" alt="Boheme Apartments at CityVillage" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
                                <a href="#" target="_self">Boheme Apartments at CityVillage</a>        </h4>
                            <div class="featured_houses_location"><i class="fa fa-map-marker"></i> Fleischmarkt 20&nbsp;</div>              <div class="featured_houses_category">
                                <i class="fa fa-tag"></i>
                                <a href="#" class="category">
                                    Apartment</a>
                            </div>
                            <div class="featured_houses_size featured_houses_inline"><i class="fa fa-expand"></i> 115&nbsp;Sqrt</div><div class="featured_houses_rooms featured_houses_inline"><i class="fa fa-building-o"></i> Rooms: 6&nbsp;</div><div class="featured_houses_year featured_houses_inline"><i class="fa fa-tint"></i> Built year: 2012&nbsp;</div><div class="featured_houses_bedrooms featured_houses_inline"><i class="fa fa-inbox"></i> Bedrooms: 4&nbsp;</div><div class="featured_houses_hits featured_houses_inline"><i class="fa fa-eye"></i> Hits: 272</div>    </div>
                        <div class="rem_house_viewlist">
                            <a href="#" target="_self" style="display: block">
                                <div class="featured_houses_price ">610.000,00&nbsp;USD</div><div class="featured_houses_viewlisting">View listing</div>                </a>
                            <div style="clear: both;"></div>
                        </div>
                    </div>
                </div>
                ...
                <!-- 3 -->
                <div class="featured_houses tab-pane fade" id="Kitchen">
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="http://wp1.themexlab.com/wp/dreamland/wp-content/uploads/2016/01/3.jpg" alt="Avenel House" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                ...
                <!-- 4 -->
                <div class="featured_houses tab-pane fade" id="Garage">
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="http://ordasvit.com/joomla-sweet-home//components/com_realestatemanager/photos/100CCEE2-2208-D39C-E485-7602598B1AB9_haus1-2_808_440_2_.jpg" alt="Avenel House" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
                ...
                <!-- 5 -->
                <div class="featured_houses tab-pane fade" id="Bedroom">
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="http://ordasvit.com/joomla-sweet-home//components/com_realestatemanager/photos/100CCEE2-2208-D39C-E485-7602598B1AB9_haus1-2_808_440_2_.jpg" alt="Avenel House" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
