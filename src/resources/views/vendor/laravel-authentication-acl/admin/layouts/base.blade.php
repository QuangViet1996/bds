...
<head>
    ...
    {!! HTML::style('//netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css') !!}
      ...
      {!! HTML::style('packages/jacopo/laravel-authentication-acl/_css/afix.css') !!}
      {!! HTML::style('packages/jacopo/laravel-authentication-acl/_css/header-main.css') !!}
      
      {!! HTML::style('packages/jacopo/laravel-authentication-acl/css/jquery-ui.css') !!}
    ...
    <body>
        ...
        {!! HTML::script('packages/jacopo/laravel-authentication-acl/js/vendor/jquery-ui.min.js') !!}
        {!! HTML::script('packages/jacopo/laravel-authentication-acl/js/vendor/bootstrap.min.js') !!}
        
        {!! HTML::script('packages/jacopo/laravel-authentication-acl/js/vendor/sidebar-left.js') !!}
        {!! HTML::script('packages/jacopo/laravel-authentication-acl/js/vendor/scripts.js') !!}
