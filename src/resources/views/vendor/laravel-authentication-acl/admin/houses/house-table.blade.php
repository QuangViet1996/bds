...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="witdh:10%">
                 <a href="{!! URL::route('houses.edit', ['id' => $houses->real_estate_id]) !!}" title='{{ trans('front.testimonials.edit') }}' class="margin-left-5">
                     <i class="fa fa-pencil-square-o fa-2x"></i>
                 </a>
                 <a href="{!! URL::route('houses.delete',['id' =>$houses->real_estate_id, '_token' => csrf_token()]) !!}"  title='{{ trans('front.testimonials.delete') }} ' class="margin-left-5">
