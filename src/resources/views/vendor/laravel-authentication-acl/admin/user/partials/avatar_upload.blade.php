<div class="row">
    ...
    <div class="col-md-6">
        ...
        {!! Form::label('avatar',$user_profile->avatar ? trans('front.users.change_avata').': ' : trans('front.users.upload_avata').': ') !!}
        ...
        <div class="form-group">
            {!! Form::submit(trans('front.users.upload_avata'), ['class' => 'btn btn-info']) !!}
        </div>
        {!! Form::close() !!}
    </div>
</div>