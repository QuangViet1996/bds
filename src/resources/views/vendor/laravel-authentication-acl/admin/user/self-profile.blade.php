                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        ...
                        <div class="form-group">
                            {!! Form::label('password',trans('front.users.new_password').':') !!}
                            {!! Form::password('password', ['class' => 'form-control']) !!}
                        </div>
                        <span class="text-danger">{!! $errors->first('password') !!}</span>
                        <!-- password_confirmation text field -->
                        <div class="form-group">
                            {!! Form::label('password_confirmation',trans('front.users.create_confirm_password').':') !!}
...
<!--                        <div class="form-group">
                        ...
                        <!-- state text field -->
<!--                        <div class="form-group">
                            {!! Form::label('state',trans('front.users.state').': ') !!}
