    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['route'=>['agency.edit'],  'files'=>true, 'method' => 'post'])  !!}
                ...
                <div class="tab-content">
                    ...
                    <div id="home" class="tab-pane fade in active">
                        @include('laravel-authentication-acl::admin.agency.config-overview')
                    </div>
                    
                    <!--config-attributes-->
                    <div id="menu1" class="tab-pane fade">
                        @include('laravel-authentication-acl::admin.agency.config-attributes')
                    </div>
                    
                    <!--config-images--->
                    <div id="menu2" class="tab-pane fade">
                        @include('laravel-authentication-acl::admin.agency.config-images')
                    </div>
                    
                    <!--config-map-->
                    <div id="menu3" class="tab-pane fade">
                        @include('laravel-authentication-acl::admin.agency.config-map')
                    </div>
                </div>
                ...
                <a href="{!! URL::route('agency.delete',['id' => $realestate->real_estate_id, '_token' => csrf_token()]) !!}" class="btn btn-danger pull-right margin-left-5 delete">{!!trans('re.delete')!!}</a>
