<div class="row">
    <div class="col-md-12 margin-bottom-12">
        <a href="{!! URL::route('agency.add') !!}" class="btn btn-info pull-right"><i class="fa fa-plus"></i>{!!trans('re.add_new')!!}</a>
    </div>
</div>
...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="witdh:10%">
                 <a href="{!! URL::route('agency.edit', ['id' => $houses->real_estate_id]) !!}" title='{{ trans('re.edit') }}' class="margin-left-5">
                     <i class="fa fa-pencil-square-o fa-2x"></i>
                 </a>
                 <a href="{!! URL::route('agency.delete',['id' =>$houses->real_estate_id, '_token' => csrf_token()]) !!}"  title='{{ trans('re.delete') }} ' class="margin-left-5">
