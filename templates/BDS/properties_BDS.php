                ...
                <div class="featured_houses tab-pane fade in active" id="All">
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="images/32.jpg" alt="Avenel House" border="0"></a>    <div class="col_rent">
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="images/32.jpg" alt="Ocean Home" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="images/32.jpg" alt="House in Bel Air" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="images/32.jpg" alt="Spacious and elegant family entertainer" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="images/32.jpg" alt="Elegantly cottage in sunny California" border="0"></a>    <div class="col_rent">
                    ...
                    <div class="featured_houses_block col-md-4 col-sm-6 col-xs-12">
                        <div style="position:relative">
                            <a href="#" target="_self"> <img src="images/32.jpg" alt="Boheme Apartments at CityVillage" border="0"></a>    <div class="col_rent">
                                For sale                </div><!-- col_rent -->
                        </div>
                        <div class="feature_texthouse">
                            <h4 class="featured_houses_title">
